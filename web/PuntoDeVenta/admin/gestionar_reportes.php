...
<body>
    <div class="container">
        ...
        <a href="../admin/reportes/reporteVentas.php?token=<?= htmlspecialchars($_SESSION['token']) ?>&usuario=<?= htmlspecialchars($_SESSION['tipo_usu']) ?>" class="btn btn-primary mb-4">Reporte de ventas totales</a>
            <a href="../admin/reportes/ventas_facturadas.php?token=<?= htmlspecialchars($_SESSION['token']) ?>&usuario=<?= htmlspecialchars($_SESSION['tipo_usu']) ?>" class="btn btn-primary mb-4">Reporte de ventas facturadas</a>
