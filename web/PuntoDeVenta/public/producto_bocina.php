...
WHERE producto.catalogo LIKE 'Bocinas' AND producto.estatus LIKE 'activo' AND inventario.stock>=1";
    ...
    <div class="card-body">
        ...
        <?php 
            ...
            $sql_stock = "SELECT inventario.stock,sucursal.nombre
                ...
                WHERE producto.catalogo LIKE 'Bocinas' AND producto.estatus LIKE 'activo' AND producto.id_producto = '$id_prod' AND inventario.stock>=1";
