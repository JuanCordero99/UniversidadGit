...
<head>
    ...
    <link rel="stylesheet" href="../user/carrito.css">
</head>
</head>
<body style="background-color: #777; display: flex; flex-direction: column; min-height: 100vh;">
    ...
    <a href="../public/index.php" class="boton" id="enlace-volver" name="enlace-volver" style="text-decoration: none; color: #333; border: 2px solid black;">Volver a Productos</a>
    <button type="submit" class="boton" id="añadir-carrito" name="añadir_carrito" value="añadir" style="text-decoration: none; color: #333; padding: 10px 20px; border: 2px solid black;">
        <a href="../creacion-inicioCuenta/iniciarSesion.html" style="text-decoration: none; color: #333;">Añadir al Carrito</a>
    </button>
</div>
