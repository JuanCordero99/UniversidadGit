...
WHERE producto.catalogo LIKE 'Smartwatch' AND producto.estatus LIKE 'activo' AND inventario.stock>=1";
    ...
    <div class="card-body">
        ...
        <?php 
            ...
            $sql_stock = "SELECT inventario.stock,sucursal.nombre
                ...
                WHERE producto.catalogo LIKE 'Smartwatch' AND producto.estatus LIKE 'activo' AND producto.id_producto = '$id_prod' AND inventario.stock>=1";
        ...
        <a href="visualizacion_completa.php?id_producto=<?php echo htmlspecialchars($producto['id_producto']);?>" class="btn btn-primary">Ver más detalles</a>
    </div>
</div>
</div>
<?php endwhile; ?>
